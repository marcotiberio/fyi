...
namespace Flynt\Components\ListingFutureEvents;
...
add_filter('Flynt/addComponentData?name=ListingFutureEvents', function ($data) {
    global $post;
    if ($post) {
        $data['postSlug'] = $post->post_name;
...
Options::addTranslatable('ListingFutureEvents', [
    [
